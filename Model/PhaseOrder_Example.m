...
[~, ~] = PlotSpectrum([Ttem.ValueBase, Ttem.ValueHarm, Ttem.ValueFinal], Fs);

%% Plot signal wave

figure("Name", "Plot signal waves");
plot(T.ValueBase);
hold on;
